...
export function PersonNode({ data }: { data: { person: Person } }) {
  ...
  return (
    <div className="w-52 rounded-2xl border border-border bg-white p-3 shadow-md">
      ...
      <p className="text-base font-semibold">{person.firstName}</p>
      <p className="text-sm text-slate-600">{person.lastName}</p>
